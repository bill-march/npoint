...
#ifndef _NPOINT_MLPACK_MATCHERS_UNORDERED_MULTI_MATCHER_HPP_
#define _NPOINT_MLPACK_MATCHERS_UNORDERED_MULTI_MATCHER_HPP_
...
namespace npoint_mlpack {
  ...
  public:
    ...
    UnorderedMultiMatcher(const std::vector<arma::mat*>& data_in,
