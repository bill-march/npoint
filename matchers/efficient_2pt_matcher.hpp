/**
 * @file efficient_2pt_matcher.hpp
...
#ifndef _NPOINT_MLPACK_MATCHERS_EFFICIENT_2PT_MATCHER_HPP_
#define _NPOINT_MLPACK_MATCHERS_EFFICIENT_2PT_MATCHER_HPP_
...
namespace npoint_mlpack {
  ...
  private:
    ...
    double lower_bounds_sqr_ptr_[1];
    double upper_bounds_sqr_ptr_[1];
  ...
  public:
     ...
     */
    Efficient2ptMatcher(const std::vector<arma::mat*>& data_in,
     ...
     */
    Efficient2ptMatcher(const Efficient2ptMatcher& other, bool is_copy = false);
     ...
     */
    void SumResults(const Efficient2ptMatcher& left_matcher,
